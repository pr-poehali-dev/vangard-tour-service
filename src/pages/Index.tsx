      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-0" style={{ background: "linear-gradient(180deg,rgba(10,10,11,.95) 0%,transparent 100%)", backdropFilter: "blur(10px)" }}>
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center">
            <img src="https://cdn.poehali.dev/projects/caf2394d-110f-40c6-a52c-8e6cb8e9cddd/bucket/3dd70169-1b50-43e2-88ad-b6a334b670b1.svg" alt="Ван Гард" className="h-24 w-auto" />
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <AnimSection>
            <div className="glass-card rounded-3xl p-12 text-center" style={{ borderColor: "rgba(201,168,76,0.25)" }}>
              ...
              <h2 className="font-display text-5xl md:text-6xl font-light mb-6 text-center md:text-left">
